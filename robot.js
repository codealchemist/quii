...
function init (five, board) {
  ...
  quad.legs = new five.Servos([quad.r1c, quad.r1f, quad.l1c, quad.l1f, quad.r2c, quad.r2f, quad.l2c, quad.l2f])
  ...
  quad.att = function quadStand() {
    let grouped,
      work = [
        { name: 'r1', offset: 0, home: s.front.femur[1], chome: s.front.coxa[1] },
        { name: 'r2', offset: 0, home: s.rear.femur[1], chome: s.front.coxa[1] },
        { name: 'l1', offset: 0, home: s.front.femur[1], chome: s.front.coxa[1] },
        { name: 'l2', offset: 0, home: s.rear.femur[1], chome: s.front.coxa[1] }
      ]

    work.forEach((leg, i) => {
      work[i].offset = Math.abs(quad[leg.name + 'f'].last.reqDegrees - leg.home)
    })
